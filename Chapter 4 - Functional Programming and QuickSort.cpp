...
//	
//	auto divide_point = std::partition (input.begin (), input.end (), [&] (const auto& val) {	//Partition will return a pointer to the first value that FAILED the check --AKA firt value in bigger than pivot group
