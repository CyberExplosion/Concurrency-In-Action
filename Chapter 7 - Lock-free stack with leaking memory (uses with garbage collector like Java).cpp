...
// //We cannot exactly go in and make a delete function yet. There's a chance we would delete something that the thread hasn't finished getting the data out
// int main () {
